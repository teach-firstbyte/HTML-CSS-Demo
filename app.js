// Precode in some functions choose a function for them to build out
/* ── COLOURS ────────────────────────────────────────────────
...
─────────────────────────────────────────────────────────── */
var habits = [
  // PRESET SOME HABITS HERE
  // { id: '0', name: 'Drink water', color: COLORS[3] },
];
var completions = ['0'];
...
/* ── ACTION: switchTab ──────────────────────────────────────
  ...
  How can you use this logic to hide and show the correct tabs/buttons?
─────────────────────────────────────────────────────────── */
...
/* ── ACTION: toggleHabit ────────────────────────────────────
   ...
   indexOf() is a JavaScript function that returns the index of the first occurrence of a value in an array.
   push() is a JavaScript function that adds a new element to the end of an array.
   splice() is a JavaScript function that removes elements from an array.

   Given a habit's id, how could we toggle it between completed and not completed?
─────────────────────────────────────────────────────────── */
